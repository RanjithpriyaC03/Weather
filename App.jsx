...
return(
    <>
  <div className="image">
    <img src={icon} alt="Image"  width={150}/>
    </div>
  ...
  <span>{log}</span>
    ...
    <div className="data-container">
      <div className="element">
        <img src={humidityIcon} alt="humidity" width={50}   className='icon' ></img>
<div className="data">
  ...
  <div className="text">Humidity</div>
      ...
      <div className="element">
        <img src={windIcon} alt="wind" width={50}   className='icon' ></img>
<div className="data">
...
function App() {
  let api_key="14a9c019e6c625e395a09fdb74676911";
...
<div className="container">
  ...
  <p className="copyright">
    Designed by <span>Ranjithpriya</span>
  </p>
</div>
